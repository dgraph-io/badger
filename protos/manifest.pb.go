...
type ManifestChange_Category int32

const (
	ManifestChange_TABLE ManifestChange_Category = 0
	ManifestChange_VLOG  ManifestChange_Category = 1
)

var ManifestChange_Category_name = map[int32]string{
	0: "TABLE",
	1: "VLOG",
}
var ManifestChange_Category_value = map[string]int32{
	"TABLE": 0,
	"VLOG":  1,
}

func (x ManifestChange_Category) String() string {
	return proto.EnumName(ManifestChange_Category_name, int32(x))
}
func (ManifestChange_Category) EnumDescriptor() ([]byte, []int) {
...
func (ManifestChange_Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorManifest, []int{1, 1}
}
...
type ManifestChange struct {
	...
	Cat   ManifestChange_Category  `protobuf:"varint,2,opt,name=Cat,proto3,enum=protos.ManifestChange_Category" json:"Cat,omitempty"`
	Op    ManifestChange_Operation `protobuf:"varint,3,opt,name=Op,proto3,enum=protos.ManifestChange_Operation" json:"Op,omitempty"`
...
func (m *ManifestChange) GetCat() ManifestChange_Category {
	if m != nil {
		return m.Cat
	}
	return ManifestChange_TABLE
}
...
func init() {
	...
	proto.RegisterEnum("protos.ManifestChange_Category", ManifestChange_Category_name, ManifestChange_Category_value)
...
func (m *ManifestChange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Cat != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintManifest(dAtA, i, uint64(m.Cat))
	}
	if m.Op != 0 {
		dAtA[i] = 0x18
		i++
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Cat |= (ManifestChange_Category(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorManifest = []byte{
	...
	,
