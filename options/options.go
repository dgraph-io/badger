...
type Options struct {
	...
	ChecksumVerificationMode ChecksumVerificationMode
...
func (opt Options) WithTableLoadingMode(val FileLoadingMode) Options {
...
func (opt Options) WithValueLogLoadingMode(val FileLoadingMode) Options {
