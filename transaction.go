...
//
// 5. If callback is provided, method will return as soon as Badger has checked
// for conflicts. Writes to database will happen in the background, and the
// callback will be called upon successful completion or error.
//
