...
// for conflicts. Actual writes to the database will happen in the background.
// If there is a conflict, an error will be returned and the callback will not
// run. If there are no conflicts, the callback will be called upon successful
// completion of writes or errors during write.
//
