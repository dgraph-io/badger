...
var backupCmd = &cobra.Command{
	Use:   "backup",
	Short: "Backup a Badger database.",
	Long: `Backup a Badger database to a file in a version-agnostic manner.
...
func init() {
	...
	backupCmd.Flags().StringVarP(&backupFile, "backup-file", "f", "badger.bak", "File to backup to")
}
