...
type KVList struct {
	...
	// allocator_id used internally for memory management.
	AllocatorId          uint64   `protobuf:"varint,10,opt,name=allocator_id,json=allocatorId,proto3" json:"allocator_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *KVList) GetAllocatorId() uint64 {
	if m != nil {
...
var fileDescriptor_e63e84f9f0d3998c = []byte{
	...
	,
}
...
func (m *KVList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.AllocatorId != 0 {
		i = encodeVarintBadgerpb2(dAtA, i, uint64(m.AllocatorId))
		i--
		dAtA[i] = 0x50
	}
	if len(m.Kv) > 0 {
...
func (m *KVList) Size() (n int) {
	...
	if m.AllocatorId != 0 {
		n += 1 + sovBadgerpb2(uint64(m.AllocatorId))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *KVList) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllocatorId", wireType)
			}
			m.AllocatorId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AllocatorId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
