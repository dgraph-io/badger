...
// Enum value maps for KV_Kind.
var (
	KV_Kind_name = map[int32]string{
		0: "KEY",
		1: "DATA_KEY",
		2: "FILE",
	}
	KV_Kind_value = map[string]int32{
		"KEY":      0,
		"DATA_KEY": 1,
		"FILE":     2,
	}
...
func (KV_Kind) Descriptor() protoreflect.EnumDescriptor {
	return file_badgerpb4_proto_enumTypes[1].Descriptor()
}

func (KV_Kind) Type() protoreflect.EnumType {
	return &file_badgerpb4_proto_enumTypes[1]
}

func (x KV_Kind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use KV_Kind.Descriptor instead.
func (KV_Kind) EnumDescriptor() ([]byte, []int) {
	return file_badgerpb4_proto_rawDescGZIP(), []int{0, 0}
}
...
func (Checksum_Algorithm) Descriptor() protoreflect.EnumDescriptor {
	return file_badgerpb4_proto_enumTypes[3].Descriptor()
}

func (Checksum_Algorithm) Type() protoreflect.EnumType {
	return &file_badgerpb4_proto_enumTypes[3]
}
...
type KV struct {
	...
	Kind       KV_Kind `protobuf:"varint,12,opt,name=kind,proto3,enum=badgerpb4.KV_Kind" json:"kind,omitempty"`
}
...
var file_badgerpb4_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x62, 0x61, 0x64, 0x67, 0x65, 0x72, 0x70, 0x62, 0x34, 0x22, 0xa5, 0x02, 0x0a,
	...
	,
	...
	0x32, 0x19, 0x2e, 0x62, 0x61, 0x64, 0x67, 0x65, 0x72, 0x70, 0x62, 0x34, 0x2e, 0x4d, 0x61, 0x6e,
	0x69, 0x66, 0x65, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x07, 0x63, 0x68, 0x61,
	0x6e, 0x67, 0x65, 0x73, 0x22, 0x8d, 0x02, 0x0a, 0x0e, 0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73,
	0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x02, 0x49, 0x64, 0x12, 0x33, 0x0a, 0x02, 0x4f, 0x70, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x62, 0x61, 0x64, 0x67, 0x65, 0x72, 0x70, 0x62, 0x34, 0x2e,
	0x4d, 0x61, 0x6e, 0x69, 0x66, 0x65, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x4f,
	...
	,
	...
	,
...
var file_badgerpb4_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_badgerpb4_proto_goTypes = []interface{}{
	...
	(KV_Kind)(0),                  // 1: badgerpb4.KV.Kind
	(ManifestChange_Operation)(0), // 2: badgerpb4.ManifestChange.Operation
	(Checksum_Algorithm)(0),       // 3: badgerpb4.Checksum.Algorithm
	(*KV)(nil),                    // 4: badgerpb4.KV
	(*KVList)(nil),                // 5: badgerpb4.KVList
	(*ManifestChangeSet)(nil),     // 6: badgerpb4.ManifestChangeSet
	(*ManifestChange)(nil),        // 7: badgerpb4.ManifestChange
	(*Checksum)(nil),              // 8: badgerpb4.Checksum
	(*DataKey)(nil),               // 9: badgerpb4.DataKey
	(*Match)(nil),                 // 10: badgerpb4.Match
}
var file_badgerpb4_proto_depIdxs = []int32{
	1, // 0: badgerpb4.KV.kind:type_name -> badgerpb4.KV.Kind
	4, // 1: badgerpb4.KVList.kv:type_name -> badgerpb4.KV
	7, // 2: badgerpb4.ManifestChangeSet.changes:type_name -> badgerpb4.ManifestChange
	2, // 3: badgerpb4.ManifestChange.Op:type_name -> badgerpb4.ManifestChange.Operation
	0, // 4: badgerpb4.ManifestChange.encryption_algo:type_name -> badgerpb4.EncryptionAlgo
	3, // 5: badgerpb4.Checksum.algo:type_name -> badgerpb4.Checksum.Algorithm
