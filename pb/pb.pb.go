...
type TableIndex struct {
	...
	KvSize               uint64         `protobuf:"varint,3,opt,name=kv_size,json=kvSize,proto3" json:"kv_size,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *TableIndex) GetKvSize() uint64 {
	if m != nil {
		return m.KvSize
	}
	return 0
...
var fileDescriptor_f80abaa17e25ccc8 = []byte{
	...
	,
}
...
func (m *TableIndex) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.KvSize != 0 {
		i = encodeVarintPb(dAtA, i, uint64(m.KvSize))
		i--
		dAtA[i] = 0x18
	}
