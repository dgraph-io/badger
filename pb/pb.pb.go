...
const (
	...
	Checksum_XXHash Checksum_Algorithm = 1
)
...
type Checksum struct {
	...
	Sum32                uint32             `protobuf:"varint,2,opt,name=sum32,proto3" json:"sum32,omitempty"`
	Sum64                uint64             `protobuf:"varint,3,opt,name=sum64,proto3" json:"sum64,omitempty"`
...
func (m *Checksum) GetSum32() uint32 {
	if m != nil {
		return m.Sum32
	}
	return 0
...
var fileDescriptor_f80abaa17e25ccc8 = []byte{
	...
	,
}
...
func (m *Checksum) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Sum32 != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintPb(dAtA, i, uint64(m.Sum32))
	}
	if m.Sum64 != 0 {
		dAtA[i] = 0x18
		i++
...
func (m *Checksum) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Sum32", wireType)
			}
			m.Sum32 = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
