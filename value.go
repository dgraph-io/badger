...
// getEncodedDiscardStats returns []byte representation of lfDiscardStats
// This will be called while storing stats in BadgerDB
func (vlog *valueLog) getEncodedDiscardStats() []byte {
	vlog.lfDiscardStats.Lock()
...
func (vlog *valueLog) populateDiscardStats() error {
	...
	if err := json.Unmarshal(vs.Value, &statsMap); err != nil {
		// TODO: should we return error or initialize it with empty map
		return err
	}
